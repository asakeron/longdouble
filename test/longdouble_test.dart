  ...
  group("operations", () {
    ...
    group("multiplication", () {
      ...
      test(
          "100 * 12.34",
          () => expect(
              (new longdouble(100.0) * new longdouble(12.34)).toDouble(),
              1234.0));
      test("0.34 * 10", () {
        expect((longdouble.parse("0.34") * 10.0).toDouble(),
            equals(new longdouble(3.4)));
      });
    });
    group("division", () {
  ...
  group("parse", () {
    ...
    test("\'0.34\'", () {
      expect(longdouble.parse("0.34"),
          equals(new longdouble(0.34, -2.4424906541753444e-17)));
    });
    test("\'1234\'", () {
    ...
    test("\'1.234e-14", () {
      expect(longdouble.parse("1.234e-14"),
          equals(new longdouble(1.234e-14, 6.425030031206563e-31)));
    });
  });
}
